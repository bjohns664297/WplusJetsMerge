...
VjetsPythia8: $(PYTHIA) VjetsPythia8.o ANA_utils.o TruthPart.o TruthJets.o 
ifeq ($(FASTJET3_USE)$(HEPMC2_USE)$(ROOT_USE),truetruetrue)
	$(CXX) VjetsPythia8.o ANA_utils.o TruthPart.o TruthJets.o -o $@ -w $(FASTJET3_INCLUDE) $(HEPMC2_INCLUDE) $(CXX_COMMON)\
...
VjetsPythia8.o: $(PYTHIA) VjetsPythia8.cc VjetsPythia8.h ANA_utils.h StdArg.hpp TruthPart.h TruthJets.h 
ifeq ($(FASTJET3_USE)$(HEPMC2_USE)$(ROOT_USE),truetruetrue)
	${CXX} -c ${CXXFLAGS} VjetsPythia8.cc -w $(HEPMC2_INCLUDE) $(FASTJET3_INCLUDE) $(CXX_COMMON)\
        $(FASTJET3_LIB) -lfastjettools $(HEPMC2_LIB) $(ROOT_LIB) `$(ROOT_CONFIG) --cflags --glibs`
else
        @echo "Error: $@ requires ROOT, FASTJET3 and HEPMC2"
endif
